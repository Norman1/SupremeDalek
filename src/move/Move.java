...
public class Move {
	...
	private String illegalMove = ""; // gets the value of the error message if
										// move is illegal, else remains empty
	...
	/**
	 * @param illegalMove
	 *            Sets the error message of this move. Only set this if the Move
	 *            is illegal.
	 */
